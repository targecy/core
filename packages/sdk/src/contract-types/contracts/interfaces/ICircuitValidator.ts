...
export interface ICircuitValidatorInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'getChallengeInputIndex' | 'getCircuitId' | 'getUserIdInputIndex' | 'verify'
  ): FunctionFragment;

  encodeFunctionData(functionFragment: 'getChallengeInputIndex', values?: undefined): string;
  encodeFunctionData(functionFragment: 'getCircuitId', values?: undefined): string;
  encodeFunctionData(functionFragment: 'getUserIdInputIndex', values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'getChallengeInputIndex', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getCircuitId', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getUserIdInputIndex', data: BytesLike): Result;
...
export interface ICircuitValidator extends BaseContract {
  ...
  functions: {
    getChallengeInputIndex(overrides?: CallOverrides): Promise<[BigNumber] & { index: BigNumber }>;

    getCircuitId(overrides?: CallOverrides): Promise<[string] & { id: string }>;

    getUserIdInputIndex(overrides?: CallOverrides): Promise<[BigNumber] & { index: BigNumber }>;
  ...
  populateTransaction: {
    getChallengeInputIndex(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getCircuitId(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getUserIdInputIndex(overrides?: CallOverrides): Promise<PopulatedTransaction>;
