    ...
    <div>
      <div className="space-y-8">
        ...
        <div className="panel">
          ...
          <div className="mb-5">
            <p className="mb-5">
              Solar is a collection of simply beautiful open source icons. Each icon is designed on a 24x24 grid with an
              emphasis on simplicity, consistency and usability.
            </p>
            <div className="mb-5 inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">
              Line Duotone
            </div>
