            ...
            <Swiper
              ...
              <div className="swiper-wrapper">
                {items.map((item, i) => {
                  return (
                    <SwiperSlide key={i}>
                      <img src={`/images/${item}`} className="max-h-80 w-full object-cover" alt="itemImage" />
                    </SwiperSlide>
                  );
                })}
              </div>
...
>
    <div className="swiper-wrapper">
        {items.map((item, i) => {
            return (
                <SwiperSlide key={i}>
                    <img src={\`/images/\${item}\`} className="w-full max-h-80 object-cover" alt="itemImage" />
                </SwiperSlide>
            );
        })}
    </div>
            ...
            <Swiper
              ...
              <div className="swiper-wrapper">
                {items.map((item, i) => {
                  return (
                    <SwiperSlide key={i}>
                      <img src={`/images/${item}`} className="w-full" alt="itemImage" />
            ...
            <div className="swiper mx-auto mb-5 max-w-3xl" id="slider4">
              <div className="swiper-wrapper">
                <Swiper
                  ...
                  key={themeConfig.rtlClass === 'rtl' ? 'true' : 'false'}>
                  <SwiperSlide>
                    <img src="/images/carousel1.jpeg" className="w-full" alt="slide1" />
                  ...
                  <SwiperSlide>
                    <img src="/images/carousel2.jpeg" className="w-full" alt="slide2" />
                    <div className="absolute bottom-8 left-1/2 z-[999] w-full -translate-x-1/2 px-11 text-center text-white sm:px-0">
                  ...
                  <SwiperSlide>
                    <img src="/images/carousel3.jpeg" className="w-full" alt="slide3" />
                    <div className="absolute bottom-8 left-1/2 z-[999] w-full -translate-x-1/2 px-11 text-center text-white sm:px-0">
              ...
              <div className="swiper-wrapper">
                <Swiper
                  ...
                  {items.map((item, i) => {
                    return (
                      <SwiperSlide key={i}>
                        <img src={`/images/${item}`} className="w-full" alt="itemImg" />
                      </SwiperSlide>
                    );
                  })}
                  {items.map((item, i) => {
