...
const MediaObject = () => {
  ...
  return (
          ...
          <div className="mb-5">
            <div className="flex">
              <div className="ltr:mr-4 rtl:ml-4">
                <img src="/images/profile-5.jpeg" alt="img" className="h-16 w-16 rounded" />
              </div>
              <div className="flex-1">
                <h4 className="mb-2 text-lg font-semibold text-primary">Heading</h4>
                <p className="media-text">
                  Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean
                  dignissim sed ante eget dapibus. Sed dapibus nulla elementum, rutrum neque eu, gravida neque.
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="flex">
        <div className="ltr:mr-4 rtl:ml-4">
            <img src="/images/profile-5.jpeg" alt="img" className="w-16 h-16 rounded" />
        </div>
        <div className="flex-1">
          ...
          <div className="mb-5">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="media-text">
                  Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean
                  dignissim sed ante eget dapibus. Sed dapibus nulla elementum, rutrum neque eu, gravida neque. Fusce
                  condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean dignissim sed
                  ante eget dapibus. Sed dapibus nulla elementum, rutrum neque eu, gravida neque.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="panel">
          ...
          <div className="mb-5">
            <div className="mb-5 flex">
              <div className="ltr:mr-4 rtl:ml-4">
                <img src="/images/profile-5.jpeg" alt="img" className="h-14 w-14 rounded" />
              </div>
              <div className="flex-1">
                <h4 className="mb-2 text-lg font-semibold text-primary">Heading</h4>
                <p className="media-text">
    ...
    <div className="flex mb-5">
        <div className="ltr:mr-4 rtl:ml-4">
            <img src="/images/profile-5.jpeg" alt="img" className="w-14 h-14 rounded" />
        </div>
        <div className="flex-1">
            <h4 className="font-semibold text-lg mb-2 text-primary">Heading</h4>
            <p className="media-text">
                  ...
                  <li>
                    <button type="button" className="flex items-center hover:text-primary">
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-4 w-4 ltr:mr-1 rtl:ml-1">
                        <path
