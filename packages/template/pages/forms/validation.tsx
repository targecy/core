                ...
                {({ errors, submitCount, touched, values }) => (
                  <Form className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-4">
                      <div
                        className={`md:col-span-2 ${submitCount ? (errors.city ? 'has-error' : 'has-success') : ''}`}>
                  ...
                  <Form className="space-y-5">
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                      <div className={submitCount ? (errors.firstname ? 'has-error' : 'has-success') : ''}>
                        ...
                        {submitCount ? (
                          errors.firstname ? (
                            <div className="inline-block rounded bg-danger py-1 px-2 text-white">
                              {errors.firstname}
                            </div>
                          ) : (
                    ...
                    <div className={submitCount ? (errors.agree ? 'has-error' : 'has-success') : ''}>
                      ...
                      <div className="mt-2">
                        {submitCount ? (
                          errors.agree ? (
                            <div className="inline-block rounded bg-danger py-1 px-2 text-white">{errors.agree}</div>
                          ) : (
                            ''
                          )
                        ) : (
