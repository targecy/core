    ...
    <div>
      ...
      <div className="space-y-8 pt-5">
        <div className="space-y-8" id="date_time_picker">
          <div className="inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">
              ...
              <div className="mb-5 pt-5">
                ...
                <div className="my-5 grid grid-cols-1 gap-8 font-bold lg:grid-cols-2">
                  <div>
                    ...
                    <span
                      className="rounded border border-white-light py-1 px-2 text-dark dark:border-dark dark:text-white-dark"
                      id="nouiMin2Perc">
                      {`${parseInt(percent2[0])}%`}
                    </span>
                  </div>
