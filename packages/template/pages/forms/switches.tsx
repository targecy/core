...
const Switches = () => {
  ...
  return (
            ...
            <div className="panel">
              ...
              <div className="mb-5">
                <label className="relative h-6 w-12">
                  ...
                  <span
                    className={`outline_checkbox bg-icon block h-full border-2 border-[#ebedf2] before:absolute before:left-1 before:bottom-1 before:h-4 before:w-4 before:bg-[#ebedf2] before:bg-[url(/images/close.svg)] before:bg-center before:bg-no-repeat before:transition-all before:duration-300 peer-checked:border-primary peer-checked:before:left-7 peer-checked:before:bg-primary peer-checked:before:bg-[url(/images/checked.svg)] dark:border-white-dark dark:before:bg-white-dark`}></span>
                </label>
              </div>
    ...
    before:bg-[url(/images/close.svg)] before:bg-no-repeat before:bg-center peer-checked:before:left-7 peer-checked:before:bg-[url(/images/checked.svg)] peer-checked:border-primary peer-checked:before:bg-primary before:transition-all before:duration-300\`}
    ></span>
</label>`}</pre>
                </CodeHighlight>
              )}
              ...
              <div className="mb-5">
                <label className="relative h-6 w-12">
                  <input
                    ...
                    id="custom_switch_checkbox1"
                  />
                  <span className="outline_checkbox bg-icon block h-full rounded-full border-2 border-[#ebedf2] before:absolute before:left-1 before:bottom-1 before:h-4 before:w-4 before:rounded-full before:bg-[#ebedf2] before:bg-[url(/images/close.svg)] before:bg-center before:bg-no-repeat before:transition-all before:duration-300 peer-checked:border-primary peer-checked:before:left-7 peer-checked:before:bg-primary peer-checked:before:bg-[url(/images/checked.svg)] dark:border-white-dark dark:before:bg-white-dark"></span>
                </label>
              </div>
