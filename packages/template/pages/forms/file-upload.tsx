          ...
          <div className="panel" id="single_file">
            ...
            <div className="mb-5">
              <div className="custom-file-container" data-upload-id="myFirstImage">
                ...
                {images.length === 0 ? (
                  <img src="/images/file-preview.svg" className="m-auto w-full max-w-md" alt="" />
                ) : (
                  ''
                )}
              </div>
...
<div className="custom-file-container" data-upload-id="myFirstImage">
    ...
    {images.length === 0 ? <img src="/images/file-preview.svg" className="max-w-md w-full m-auto" alt="" /> : ''}
</div>`}</pre>
              </CodeHighlight>
            )}
          </div>
...
<div className="custom-file-container" data-upload-id="mySecondImage">
    ...
    {images2.length === 0 ? <img src="/images/file-preview.svg" className="max-w-md w-full m-auto" alt="" /> : ''}
</div>`}</pre>
              </CodeHighlight>
            )}
          </div>
