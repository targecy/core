...
const Faq = () => {
  ...
  return (
    <div>
      <div className="relative rounded-t-md bg-primary-light bg-[url('/images/knowledge/pattern.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
        <div className="-end-6 xl:end-0 absolute -bottom-1 hidden text-[#DBE7FF] rtl:rotate-y-180 dark:text-[#1B2E4B] lg:block">
          <img
            src={isDark ? '/images/faq/faq-dark.svg' : '/images/faq/faq-light.svg'}
            alt="faqs"
            className="w-56 object-cover xl:w-80"
          />
        </div>
        <div className="relative">
          <div className="sm:-ms-32 xl:-ms-60 flex flex-col items-center justify-center sm:flex-row">
          ...
          <div className="divide-y divide-white-light px-6 py-4.5 dark:divide-dark">
            <div>
              <div
                ...
                <span>How to install TARGECY Admin</span>
                {active1 !== 1 ? (
      ...
      <div className="panel mt-10 text-center md:mt-20">
        ...
        <div className="text-lg font-medium text-white-dark">
          Our specialists are always happy to help. Contact us during standard business hours or email us24/7 and we'll
          get back to you.
        </div>
