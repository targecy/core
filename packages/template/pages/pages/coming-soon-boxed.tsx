  ...
  return (
    <div>
      ...
      <div className="relative flex min-h-screen items-center justify-center bg-[url(/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
        ...
        <div className="bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)] relative w-full max-w-[870px] rounded-md p-2 text-center">
          <div className="rounded-md bg-white/60 p-4 backdrop-blur-lg dark:bg-black/50 sm:p-6">
            <div className="mx-auto mt-5 w-full max-w-[550px] md:mt-16">
              ...
              <div className="mb-20 md:mb-32">
                ...
                <div className="relative mb-10 mt-8">
                  <input
                    ...
                    className="sm:pe-32 form-input mb-5 py-3.5 placeholder:text-base placeholder:text-white-dark sm:mb-0"
                  />
                  <button
                    type="button"
              ...
              <p className="dark:text-white">© {new Date().getFullYear()}. TARGECY All Rights Reserved.</p>
            </div>
          </div>
        </div>
      </div>
