          ...
          <div className="panel h-full">
            <div className="-m-5 mb-5 flex  items-start border-b border-white-light p-5 dark:border-[#1b2e4b]">
              <div className="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                <img src="/images/profile-1.jpeg" alt="profile1" className="h-10 w-10 rounded-full object-cover" />
              </div>
            ...
            <div className="-m-5 mb-5 flex items-center  justify-between border-b border-white-light p-5 dark:border-[#1b2e4b]">
              <div className="flex">
                <div className="media-aside align-self-start">
                  <div className="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                    <img src="/images/g-8.png" alt="profile2" className="h-10 w-10 rounded-full object-cover" />
                  </div>
                </div>
                <div className="font-semibold">
          ...
          <div className="panel h-full">
            ...
            <div className="group">
              <div className="mb-5 text-white-dark">
                Doloribus nisi vel suscipit modi, optio ex repudiandae voluptatibus officiis commodi. Nesciunt quas aut
                neque incidunt!
              </div>
