 ...
 * - network definitions are in getNetworks in the '@targecy/common/src workspace: `'@targecy/common/src/functions`
 * - Named hardhat accounts are in the '@targecy/common/src workspace: `'@targecy/common/src/constants`
...
/**
 * loads network list and config from '@targecy/common/src
 */
