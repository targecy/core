...
export type AdFragmentFragment = { __typename?: 'Ad', id: string, impressions: any, minBlock: any, maxBlock: any, maxImpressionPrice: any, metadataURI: string, remainingBudget: any, totalBudget: any, advertiser: { __typename?: 'User', id: string }, targetGroups: Array<{ __typename?: 'TargetGroup', id: string, metadataURI: string, zkRequests: Array<{ __typename?: 'ZKPRequest', id: string, metadataURI: string, validator: any, query_schema: any, query_slotIndex: any, query_operator: any, query_value: Array<any>, query_circuitId: string }> }> };

export type GetAllAdsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllAdsQuery = { __typename?: 'Query', ads: Array<{ __typename?: 'Ad', id: string, impressions: any, minBlock: any, maxBlock: any, maxImpressionPrice: any, metadataURI: string, remainingBudget: any, totalBudget: any, advertiser: { __typename?: 'User', id: string }, targetGroups: Array<{ __typename?: 'TargetGroup', id: string, metadataURI: string, zkRequests: Array<{ __typename?: 'ZKPRequest', id: string, metadataURI: string, validator: any, query_schema: any, query_slotIndex: any, query_operator: any, query_value: Array<any>, query_circuitId: string }> }> }> };
