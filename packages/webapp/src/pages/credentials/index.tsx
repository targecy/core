    ...
    <>
      <div className="mb-8 w-full gap-8 sm:grid-cols-2 md:grid-cols-2 lg:grid lg:grid-cols-2">
        <div className="panel h-full w-full sm:col-span-2 md:col-span-2 lg:col-span-1">
          <div className="mb-2  dark:text-white-light">
            <h5 className="text-lg font-semibold text-primary">Enhance your profile</h5>
        ...
        <div className="panel h-full w-full sm:col-span-2 md:col-span-2 lg:col-span-1">
          <div className="mb-2  dark:text-white-light">
            ...
            <span>This anonym autogenerated identity is linked to all your credentials.</span>
          </div>
      ...
      <div className="panel">
        ...
        <div className="mb-5 flex items-center justify-between">
          <h5 className="text-2xl font-semibold text-primary">Identity Hub</h5>
        </div>
