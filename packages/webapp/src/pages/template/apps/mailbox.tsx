...
const Mailbox = () => {
  ...
  const setArchive = () => {
    if (ids.length) {
      const items = filteredMailList.filter((d: any) => ids.includes(d.id));
  ...
  const setGroup = (group: any) => {
    if (ids.length) {
      const items = mailList.filter((d: any) => ids.includes(d.id));
      for (const item of items) {
        item.group = group;
      }
                          ...
                          <tr key={mail.id} className="cursor-pointer" onClick={() => selectMail(mail)}>
                              ...
                              <div className="flex items-center whitespace-nowrap">
                                ...
                                <div className="ltr:mr-3 rtl:ml-3">
                                  <Tippy content="Important">
                                    <button
                                      type="button"
                                      className={`flex items-center enabled:hover:text-primary disabled:opacity-60 ${
                                ...
                                <div
                                  className={`whitespace-nowrap font-semibold dark:text-gray-300 ${
                                    !mail.isUnread ? 'text-gray-500 dark:text-gray-500' : ''
                                  }`}>
                            ...
                            <td>
                              <div className="line-clamp-1 min-w-[300px] overflow-hidden font-medium text-white-dark">
                                <span
                                  className={`${
                                    mail.isUnread ? 'font-semibold text-gray-800 dark:text-gray-300' : ''
                                  }`}>
            ...
            <div>
              ...
              <div className="relative p-4">
                            ...
                            <li>
                              <div className="flex items-center px-4 py-2">
                                ...
                                <div className="flex-1">
                                  {selectedMail.type === 'sent_mail' ? 'vargecy@gmail.com' : selectedMail.email}
                                </div>
                              </div>
                            </li>
                            <li>
                      ...
                      <Tippy content="Reply">
                        <button
                          ...
                          <svg
                            ...
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 ltr:hidden rtl:block">
                            <path
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: selectedMail.description }}></div>
