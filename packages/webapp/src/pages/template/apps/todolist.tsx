...
const Todolist = () => {
  ...
  const setPriority = (task: any, name: string = '') => {
    const item = filteredTasks.find((d: any) => d.id === task.id);
    item.priority = name;
    searchTasks(false);
  };
    ...
    <div>
      <div className="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
        ...
        <div
          ...
          onClick={() => setIsShowTaskMenu(!isShowTaskMenu)}></div>
                      ...
                      return (
                        <tr
                          className={`group cursor-pointer ${
                            task.status === 'complete' ? 'bg-white-light/30 dark:bg-[#1a2941] ' : ''
                          }`}
                          key={task.id}>
                          <td className="w-1">
                            <input
                                      ...
                                      <>
                                        ...
                                        <li>
                                          <button type="button" onClick={() => setImportant(task)}>
                                            <svg
                                              className="h-5 w-5 shrink-0 ltr:mr-2 rtl:ml-2 dark:text-gray-400 dark:group-hover:text-white"
                                              width="20"
                                              height="20"
                                              viewBox="0 0 24 24"
                                              fill="none"
